...
class EncaminhaDFS {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(t1.preOrder().split(" ")));
        System.out.println(Arrays.toString(t1.inOrder().split(" ")));
        System.out.println(Arrays.toString(t1.postOrder().split(" ")));
